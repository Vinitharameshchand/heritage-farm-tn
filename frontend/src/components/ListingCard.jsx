    ...
    return (
        ...
        >
            <Link to={`/listings/${listing._id}`}>
                ...
                {/* Content */}
                <div className="p-8">
                    <div className="flex items-center gap-2 text-emerald-400/60 text-xs font-bold uppercase tracking-wider mb-3">
                        <MapPin className="w-3.5 h-3.5" />
                        <span>{listing.location?.city || 'Tamil Nadu'}</span>
                    </div>

                    <h3 className="text-2xl font-outfit font-bold mb-4 group-hover:text-emerald-400 transition-colors leading-tight">
                        {listing.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-4 mb-8 text-sm text-slate-400">
                        ...
                        <div className="px-3 py-1 bg-white/5 rounded-full text-[10px] uppercase font-bold tracking-wider">
                            {listing.difficulty}
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-white/5">
                        <div>
                            <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mb-1">Starting from</div>
                            <span className="text-3xl font-black text-white font-outfit">₹{listing.price}</span>
                            <span className="text-slate-500 text-xs ml-1">/ person</span>
                        </div>
                        <div className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center group-hover:bg-emerald-600 group-hover:border-emerald-600 transition-all duration-500">
