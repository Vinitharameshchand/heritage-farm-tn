    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-black flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 font-bold tracking-widest uppercase text-xs">Initializing Neural Link...</p>
            </div>
        );
    }
        ...
        <div className="fixed inset-0 bg-black z-[100] flex flex-col">
            ...
            <div className="absolute top-0 w-full p-8 z-50 flex justify-between items-start">
                ...
                <div className="text-right">
                    ...
                    <h1 className="text-2xl font-outfit font-black text-white">{listing.title}</h1>
                    <p className="text-slate-400 text-xs">{listing.location.city}, {listing.location.district}</p>
                </div>
            </div>
            ...
            <div className="flex-1 relative">
                ...
                */}
                <model-viewer
                    src={listing.arModelUrl || "https://modelviewer.dev/shared-assets/models/Astronaut.glb"}
                    ios-src=""
            ...
            <div className="absolute bottom-10 right-10 z-50 flex flex-col gap-4">
                ...
                >
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed">
                        This 3D scan was captured using high-precision photogrammetry to preserve the heritage details of {listing.location.city}.
                    </p>
                    <div className="flex items-center gap-3 mt-6">
                        <button className="p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all" title="Reset Camera">
                            <RotateCcw className="w-4 h-4 text-slate-400" />
                        </button>
                        <button className="p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all" title="More Info">
