...
const Discover = () => {
  ...
  return (
    <div className="min-h-screen pt-28 jaor pb-20 px-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <h1 className="text-[72.4px] jaro text-white font-outfit font-black mb-4">
            {t("discover_experiences").split(" ")[0]}{" "}
            <span>
              {t("discover_experiences").split(" ").slice(1).join(" ")}
            </span>
          </h1>
          <p className="text-white text-[22.35px] jaro">
